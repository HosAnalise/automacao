...
def test_contaReceber_excluiContaReceber(init):
    ...
    try:
        ...
        Log_manager.add_log(application_type=env_application_type, level="ERROR", message=str(e), routine=f"{ContaReceber.rotina} - test_contaReceber_excluiContaReceber", error_details=str(e))
        ...
        Log_manager.add_log(
            ...
            routine=f"{ContaReceber.rotina} - test_contaReceber_excluiContaReceber",
            error_details=''
        )
