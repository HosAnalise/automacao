...
def test_contaPagar_editaConta(init):
    starTime = time.time()
    ...
    try:
        ...
        Log_manager.add_log(application_type=env_application_type, level="ERROR", message=str(e), routine=f"{ContasPagar.rotina} - test_contaPagar_editaConta", error_details=str(e))
        ...
        Log_manager.add_log(
            ...
            routine=f"{ContasPagar.rotina} - test_contaPagar_editaConta",
            error_details=''
        )
