...
def test_desktop_insere_venda(env_vars, log_manager,timestampFormat):
    ...
    parcelas = random.randint(1, 3)  # Gera um número inteiro entre 1 e 3 (inclusive)
    ...
    try:
        ...
        if difference < 1.5:  # Define um limite de tolerância de 3% (ajuste conforme necessário)
            ...
            if difference3 < 1.5:
                ...
                log_manager.add_log(
                                    ...
                                    level="INFO",
                                    message="",
                                    routine=f"mudança detectada! Diferença{difference3:.2f}% Cliente vinculado a compra", 
                                    error_details=''
                                    )        
        ...
        if difference2 < 1.5:  
            ...
            # Executar o clique na posição especificada
